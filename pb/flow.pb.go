...
type FlowMessage struct {
	...
	SCIONSrcISDAS        uint64   `protobuf:"varint,1000,opt,name=SCIONSrcISDAS,proto3" json:"SCIONSrcISDAS,omitempty"`
	SCIONDstISDAS        uint64   `protobuf:"varint,1001,opt,name=SCIONDstISDAS,proto3" json:"SCIONDstISDAS,omitempty"`
...
func (m *FlowMessage) GetSCIONSrcISDAS() uint64 {
	if m != nil {
		return m.SCIONSrcISDAS
	}
	return 0
}

func (m *FlowMessage) GetSCIONDstISDAS() uint64 {
	if m != nil {
		return m.SCIONDstISDAS
	}
	return 0
}
